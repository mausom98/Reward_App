...
class BankDetails2Screen extends StatefulWidget {
  final String id;
  BankDetails2Screen(this.id) : super();
  @override
  _BankDetails2ScreenState createState() => new _BankDetails2ScreenState();
}

class _BankDetails2ScreenState extends State<BankDetails2Screen> {
  bool verifyB = false;
  String beneName = '';
  bool loading = false;
  String uid = '';
