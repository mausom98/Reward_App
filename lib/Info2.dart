...
import './BankInfo2.dart';
import 'dart:convert';
import './BankDetails2.dart';

class Info2Screen extends StatefulWidget {
  final String phoneNO;
  Info2Screen(this.phoneNO) : super();

  @override
  _InfoScreen2State createState() => new _InfoScreen2State();
}

class _InfoScreen2State extends State<Info2Screen> {
    ...
    if (id1 != null) {
      if (this.selectedRadio == 1) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BankDetails2Screen(id1)));
      } else if (this.selectedRadio == 2) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BankInfo2Screen(id1)));
      }
    }
  }
