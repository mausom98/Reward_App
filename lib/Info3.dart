...
import './BankInfo3.dart';
import 'dart:convert';
import './BankDetails3.dart';

class Info3Screen extends StatefulWidget {
  final String phoneNO;
  Info3Screen(this.phoneNO) : super();

  @override
  _InfoScreen3State createState() => new _InfoScreen3State();
}

class _InfoScreen3State extends State<Info3Screen> {
    ...
    if (id1 != null) {
      if (this.selectedRadio == 1) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BankDetails3Screen(id1)));
      } else if (this.selectedRadio == 2) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BankInfo3Screen(id1)));
      }
    }
  }
