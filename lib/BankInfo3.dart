...
class BankInfo3Screen extends StatefulWidget {
  final String id;
  BankInfo3Screen(this.id) : super();
  @override
  _BankInfo3ScreenState createState() => new _BankInfo3ScreenState();
}

class _BankInfo3ScreenState extends State<BankInfo3Screen> {
  String uid = '';
